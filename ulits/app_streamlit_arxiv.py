...
st.set_page_config(
    page_title="arXiv Research Searcher",
    layout="wide",
)

st.title("📄 arXiv Research Paper Searcher & Summarizer")

query = st.text_input(
    "Enter research query",
    placeholder="e.g. deep learning cancer detection",
)
    ...
    if not query.strip():
        ...
        if not papers:
            ...
            if not final_papers:
                ...
                report_file = "arxiv_research_summary.docx"
